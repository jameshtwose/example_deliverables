...
def diagnostic_plots(
    ...
    _ = sns.regplot(
        ...
        scatter=True,
        lowess=True,
        line_kws={"color": JmsColors.YELLOW, "lw": 1, "alpha": 0.8},
    ...
    # _ = diagplot.axes[1].get_lines()[1].set_markerfacecolor(JmsColors.YELLOW)
