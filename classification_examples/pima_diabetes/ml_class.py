...
def plot_learning_curve(estimator, title, X, y, groups, cross_color, test_color, scoring = "accuracy", ylim=None, cv=None, n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5), figsize=(7,5)):
    """
    ...
    train_sizes, train_scores, test_scores = learning_curve(
        estimator, X, y, groups=groups, cv=cv, scoring=scoring, n_jobs=n_jobs, train_sizes=train_sizes, random_state=42)
